...
# SWOT_df <- read_csv(
#   "/Users/camryn/Documents/UNC/_Tier1_sites/expanded_Yukon_Flats/SWOT/node/hydrocron_timeseries/YR_nodes_merged_RiverSP.csv")
...
# SWORD v17b
# SWOT_df <- read_csv(
#   "/Users/camryn/Documents/UNC/_Tier1_sites/expanded_Yukon_Flats/SWOT/node/RiverTile_v17b/RiverTile_PT_node_timeseries_v17b.csv")
# SWORD v16
# SWOT_df <- read_csv(
#   "/Users/camryn/Documents/UNC/_Tier1_sites/expanded_Yukon_Flats/SWOT/node/RiverTile_v16/RiverTile_PT_node_timeseries_v16.csv")

# Remove duplicates and fill values (time = -999…, wse = -1e12)
SWOT_df_noduplicates <- SWOT_df %>%
  distinct(node_id, time, wse, .keep_all = TRUE)

# Quality filter: node_q < 2 (good/suspect), valid cross-track, <80% dark water
...
# Convert TAI time (seconds since 2000-01-01, offset 37 s from UTC) to POSIXct UTC
...
# Working directory containing PT cluster CSV files (output by toolboxes)
# --- SWORD v17b --------------------------------------------------------------
...
# Percentile / CDF / scatter plots for no bias:
...
write.csv(
  save_to_csv,
  file      = "/Users/camryn/Documents/UNC/_Tier1_sites/expanded_Yukon_Flats/CalVal_dataframes/wse/node/RiverSP_v17b/RiverSP_v17b_time_space_matched_SWOT_PT_lowerPR.csv",
  row.names = FALSE)
...
# Working directory containing all per-cluster matched CSV files
...
# Merge and label with SWOT processing version
...
write.csv(
  RiverSP_df,
  file      = "/Users/camryn/Documents/UNC/_Tier1_sites/expanded_Yukon_Flats/CalVal_dataframes/wse/node/RiverSP_v17b/node_SWOT_PT.csv",
  row.names = FALSE)
