...
# Upstream has two commented out, and misspells one as "classificaiton_qual";
# SWOTRiverEstimator looks for "classification_qual". sig0_qual was never listed.
# Without all three, process_node() raises
...
def replace_method(text, method_name, new_source):
    ...
    # Scan for the end starting AFTER the def line, not after `start` -- the def
    # line itself matches the boundary pattern and would end the block instantly.
