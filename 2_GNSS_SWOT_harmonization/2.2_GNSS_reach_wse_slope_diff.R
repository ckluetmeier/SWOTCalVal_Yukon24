...
# -----------------------------------------------------------------------------
# Select one GNSS product version.
#   SWORD v16 pairs with Version C, SWORD v17b with Version D
# -----------------------------------------------------------------------------

# --- SWORD v16 ---------------------------------------------------------------
GNSS_df <- read_csv(file.path(
  DATA_ROOT, "GNSS/_processed_data/reprocessed_2025_09_02/SWORD_v16",
  "YR_drift_reach_wse_slope.csv"))
GNSS_slope_corr_df <- read_csv(file.path(
  DATA_ROOT, "GNSS/_processed_data/reprocessed_2025_09_02/SWORD_v16",
  "YR_drift_reach_slope_corrected.csv")) %>%
  rename(reach_drift_slope_m_m_abs_nobias = slope_m_m)

# --- SWORD v17b --------------------------------------------------------------
# GNSS_df <- read_csv(file.path(
#   DATA_ROOT, "GNSS/_processed_data/reprocessed_2025_09_02/SWORD_v17b",
#   "YR_drift_reach_wse_slope.csv"))
# GNSS_slope_corr_df <- read_csv(file.path(
#   DATA_ROOT, "GNSS/_processed_data/reprocessed_2025_09_02/SWORD_v17b",
#   "YR_drift_reach_slope_corrected.csv")) %>%
