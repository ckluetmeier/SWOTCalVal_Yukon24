...
# --- Version D: RiverSP PGD0 (SWORD v17b) ------------------------------------
# node_SWOT_PT_vD <- read_csv(file.path(
#   DATA_ROOT, "CalVal_dataframes/wse/node/RiverSP_v17b/node_SWOT_PT.csv"))
...
#     river    = first(river))
#
# YR_PT_reach_slope <- read_csv(file.path(
#   DATA_ROOT, "PTs/toolboxes_dataframes/reprocessed_2025_09_02",
#   "_reach/SWORD_v17b/YR_PT_reach_slope.csv"))

# --- Version C: RiverSP PIC0 (SWORD v16) -------------------------------------
node_SWOT_PT_vC <- read_csv(file.path(
  DATA_ROOT, "CalVal_dataframes/wse/node/RiverSP_v16/node_SWOT_PT.csv"))
...
# -----------------------------------------------------------------------------
# Select one SWORD version.
# -----------------------------------------------------------------------------

# --- Version D: RiverSP PGD0 (SWORD v17b) ------------------------------------
# YR_domain     <- read_csv(file.path(
#   DATA_ROOT, "YR_domain_v17b.csv"))
#
# sword_reaches <- st_read(file.path(
#   SWORD_ROOT, "SWORD_v17b/NA/na_sword_reaches_hb81_v17b.shp"))
#
# sword_nodes   <- st_read(file.path(
#   SWORD_ROOT, "SWORD_v17b/NA/na_sword_nodes_hb81_v17b.shp"))

# --- Version C: RiverSP PIC0 (SWORD v16) -------------------------------------
YR_domain     <- read_csv(file.path(
  DATA_ROOT, "YR_domain_v16.csv"))

sword_reaches <- st_read(file.path(
  SWORD_ROOT, "SWORD_v16/NA/na_sword_reaches_hb81_v16.shp"))

sword_nodes   <- st_read(file.path(
  SWORD_ROOT, "SWORD_v16/NA/na_sword_nodes_hb81_v16.shp"))
...
# For each reach, identify the upstream (max node_id) and downstream
# (min node_id) nodes
...
# --- Version D: RiverSP PGD0 (SWORD v17b) ------------------------------------
# node_SWOT_GNSS_vD <- read_csv(file.path(
#   DATA_ROOT, "CalVal_dataframes/wse/node/RiverSP_v17b",
#   "node_SWOT_GNSS_3mdiff.csv"))
#
...
#     river = first(river))
#
# YR_GNSS_node_wse <- read_csv(file.path(
#   DATA_ROOT, "GNSS/_processed_data/reprocessed_2025_09_02",
#   "SWORD_v17b/YR_drift_node_wses.csv"))

# --- Version C: RiverSP PIC0 (SWORD v16) -------------------------------------
node_SWOT_GNSS_vC <- read_csv(file.path(
  DATA_ROOT, "CalVal_dataframes/wse/node/RiverSP_v16",
  "node_SWOT_GNSS_3mdiff.csv"))
...
YR_GNSS_node_wse <- read_csv(file.path(
  DATA_ROOT, "GNSS/_processed_data/reprocessed_2025_09_02",
  "SWORD_v16/YR_drift_node_wses.csv"))
...
write.csv(
  ...
  file      = file.path(
    DATA_ROOT, "GNSS/_processed_data/reprocessed_2025_09_02",
    "SWORD_v16/YR_drift_reach_slope_corrected.csv"),
  row.names = FALSE)
